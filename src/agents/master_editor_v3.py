"""
Master Editor V3 — Prompt Overhaul Test Version

This file contains ONLY the new V3 prompts and a thin subclass of MasterEditorV2.
Original files are NEVER modified during testing.
...
class MasterEditorV3(MasterEditorV2):
    """
    V3 test version with overhauled prompts (Changes 1-9).

    DO NOT use in production. This class exists solely for A/B testing
    the new prompt set against the V2 originals.

    Inherits all machinery from MasterEditorV2 and overrides:
