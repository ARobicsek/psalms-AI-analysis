...
doc = """# Liturgy Indexer Root Cause Analysis
...
with open('INDEXER_ROOT_CAUSE_ANALYSIS.md', 'w', encoding='utf-8') as f:
    f.write(doc)

print('✓ Document created: INDEXER_ROOT_CAUSE_ANALYSIS.md')
