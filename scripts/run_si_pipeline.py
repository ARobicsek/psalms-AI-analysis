...
def run_enhanced_pipeline(
    ...
    skip_beta_reader: bool = False,  # Session 360: beta reader runs by default (~$0.08, measurement only)
    ...
    # =====================================================================
    # STEP 5d: Beta Reader (Session 360) — reader-experience measurement.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--skip-beta-reader", action="store_true",
                       help="Skip the beta-reader step (Session 360; runs by default, ~$0.08, measurement only)")
